...
function main() {
    try {
        ...
        const postmanConfig = config.postman;
        ...
        program
            ...
            .option("--save-postman-config", "Save Postman configuration to package.json")
            .option("--project-name <name>", "Project name for Postman collection")
            .action((moduleName, fieldArgs, options) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.postman || options.postmanApiKey) {
                try {
                    ...
                    if (!postmanConfig ||
                        ...
                        if (options.postmanCollection)
                            postmanConfig.collectionId = options === null || options === void 0 ? void 0 : options.postmanCollection;
                    ...
                    if (postmanConfig && postmanConfig.apiKey) {
                        ...
                        const collection = generatePostmanCollection(result.folderName, result.camelCaseName, fields, "http://localhost:5000/api/v1");
                ...
                try {
                    ...
                    const baseUrl = config.postman.baseUrl || "http://localhost:5000/api/v1";
                    const apiResult = yield updatePostmanCollection(result.folderName, result.camelCaseName, fields, config.postman, baseUrl);
                    console.log(`✅ ${apiResult}`);
                }
                catch (error) {
